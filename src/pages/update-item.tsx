    ...
    <div className="bg-gray-50">
      <main>
        <div className="bg-white">
          <div className="mx-auto max-w-2xl px-4 pb-24 pt-16 sm:px-6 sm:pb-32 lg:grid lg:max-w-7xl lg:grid-cols-2 lg:gap-x-8 lg:px-8">
            ...
            <div className="lg:max-w-lg lg:self-end">
              ...
              >
                <div className="grid-row-1 sm:grid-row-6 grid gap-x-4 gap-y-6 pt-4">
                  ...
                  <button
                    type="submit"
                    className="mt-3 inline-flex w-full justify-center rounded-md bg-violet-500 px-3 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-violet-600 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-violet-500"
                  >
                    Submit
                  </button>
                </div>
